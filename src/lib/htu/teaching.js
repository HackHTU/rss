...
let deal = async (ctx) => {
	...
	/**
	 * @type {Array<{title: string, link: string | undefined, pubDate: Date | undefined, description?: string, enclosure?: {url: string | undefined}}>}
	 */
...
let setup = (route) => {
	route.get('/htu/teaching/:category', deal);
};
